...
**UPD: в последнее вермя я заметил, что большая часть серверов у igareck, с обходом белых списков, да и простые сервера. работают почти никак
вроде на запросы TCP отвечают, но почему то в экстренной ситуации, работать отказываются.**
**по этому, я с 13.09 по 16.09, буду делать тесты всех серверов в моей подписке, и оставлять только рабочие сервера, тесты которых были на "белых-списках". и постараюсь не забивать на неё, хотя бы ради своей доступности к интернету, в лучшей стране мира.**
...
|--------|------|--------------|
| **Mobile** (ТОП‑150, микс протоколов) | `mobile.txt` | (https://raw.githubusercontent.com/Chychelo-WIN/FUCK-RKN-VPN/main/output/mobile.txt) |
| **PC** (полный список) | `pc.txt` | (https://raw.githubusercontent.com/Chychelo-WIN/FUCK-RKN-VPN/main/output/pc.txt) |
